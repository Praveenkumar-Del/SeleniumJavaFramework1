...
public class TestNGMultiBrowserDemo {
	...
	@Parameters("browserName")       //This takes the browser name from TestNG by using keyword Parameters
	@BeforeTest
	public void setup(String browserName) {
		
		System.out.println("Browser Name is: "+browserName);
		System.out.println("Thread id : "+Thread.currentThread().getId());  //To check whether is running on multiple threads
